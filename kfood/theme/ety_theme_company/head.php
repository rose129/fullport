...
// include_once(G5_LIB_PATH.'/visit.lib.php'); // 방문자
// include_once(G5_LIB_PATH.'/connect.lib.php'); //
// include_once(G5_LIB_PATH.'/popular.lib.php'); //인기게시물
...
<div class="container-fluid top-line fixed-header">
  <?php echo latest('basic_ad','topad',1,50);?>
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div id="tnb-left">
...
<nav class="navbar fixed-top navbar-expand-lg navbar-white bg-white fixed-top">
  <div class="container">
	<a class="navbar-brand logo" href="<?php echo G5_URL?>" >
    <img src="/img/nlogo.svg" data-scrolllogo = "/img/nlogo_.svg">
...
<?php if(!defined('_INDEX_')) { ?>   <!-- 서브페이지만 나와라 -->
