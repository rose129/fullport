...
<section id="bo_w">
    ...
    <div class="write_div">
        <label for="wr_1" class="sound_only">Watermark 형태</label>
        <select name="wr_1" class="frm_input full_input">
          <option value="">Watermark 형태</option>
          <option value="text_watermark">문장</option>
          <option value="image_watermark">이미지</option>
        </select>
    </div>
